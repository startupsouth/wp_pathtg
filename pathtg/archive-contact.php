...
<?php get_header(); ?>
  ...
  <!-- hero section  -->
  <div class="container-fluid  pad-all div-sections hero pt-5">
    <div class="row justify-content-center">
      <div class="col-lg-6 pt-2 pt-lg-5">
        <span class="h6-tag mb-3 fw-bolder">cONTACT us</span>
      ...
      <div class="col-lg-5 contact">
        ...
        <ul class="p-0">
          ...
          <img src="<?php echo get_template_directory_uri (); ?>/assets/images/location.svg" alt="" class="me-3"  style="object-fit: none;">
             <span>
          ...
          <img src="<?php echo get_template_directory_uri (); ?>/assets/images/phone-icon.svg" alt="" class="me-3"  style="object-fit: none;">
            <ul class="p-0">
  ...
  <div class="container-fluid map pt-5 pb-5 mb-lg-0">
    <div class="row justify-content-center">
      <div class="col-lg-6 pe-lg-0 map-content">
 ...
 <div class="col-lg-12 input-group mb-lg-2">
          ...
          <?php   get_template_part('assets/template-parts/misc/content', 'form'); ?>
        </form>
      </div>
    </div>
  </div>
